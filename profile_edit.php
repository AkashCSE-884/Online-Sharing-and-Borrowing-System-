<?php
	...
	if(isset($_POST['edit'])){
		...
		if(password_verify($curr_password, $user['password'])){
			...
			try{
				$stmt = $conn->prepare("UPDATE usertable SET email=:email, password=:password, firstname=:firstname, lastname=:lastname, contact_info=:contact, address=:address, image=:photo WHERE id=:id");
