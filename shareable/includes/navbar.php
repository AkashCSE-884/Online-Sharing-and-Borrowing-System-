<style> 
.navbar-static-top, .sidebar-toggle,.logo-lg,.logo{
...
<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-lg"><b>Borrow & Share</b></span>
  </a>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo (!empty($admin['image'])) ? '../upload/'.$admin['image'] : '../images/profile.jpg'; ?>" class="user-image" alt="User Image">
